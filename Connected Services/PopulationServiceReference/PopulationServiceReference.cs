...
namespace PopulationServiceReference
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="PopulationServiceReference.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        System.Threading.Tasks.Task<PopulationServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(PopulationServiceReference.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public PopulationServiceReference.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(PopulationServiceReference.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public PopulationServiceReference.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(PopulationServiceReference.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface KPSPublicSoapChannel : PopulationServiceReference.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<PopulationServiceReference.KPSPublicSoap>, PopulationServiceReference.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<PopulationServiceReference.TCKimlikNoDogrulaResponse> PopulationServiceReference.KPSPublicSoap.TCKimlikNoDogrulaAsync(PopulationServiceReference.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<PopulationServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            PopulationServiceReference.TCKimlikNoDogrulaRequest inValue = new PopulationServiceReference.TCKimlikNoDogrulaRequest();
            inValue.Body = new PopulationServiceReference.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((PopulationServiceReference.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
        ...
        public class PopulationService
        {
            ...
            public async Task FetchAndSaveCitizenInfoAsync(string firstName, string lastName, string fatherName, DateTime birthDate)
            {
                try
                {
                    var client = new PopulationServiceReference.KPSPublicSoapClient(PopulationServiceReference.KPSPublicSoapClient.EndpointConfiguration.KPSPublicSoap);

                    var result = await client.TCKimlikNoDogrulaAsync(12345678901, firstName, lastName, birthDate.Year);  // 12345678901 yerine gerçek TCKN girin

                    var citizen = new CitizenInfo
                    {
                        FullName = $"{firstName} {lastName}",
                        NationalId = "12345678901", // Buraya doğrulama sonucu TCKN eklenebilir
                        BirthDate = birthDate
                    };
                    ...
                    _logger.LogInformation($"[{DateTime.Now}] Veri başarıyla kaydedildi: {citizen.FullName}");
                }
                catch (Exception ex)
                {
                    _logger.LogError(ex, "SOAP çağrısı sırasında hata oluştu.");
                }
            }
        }
